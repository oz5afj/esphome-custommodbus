...
from esphome.const import CONF_ID, CONF_DISABLED_BY_DEFAULT, CONF_ICON, CONF_ENTITY_CATEGORY, CONF_DEVICE_CLASS
...
PLATFORM_SCHEMA = cv.Schema(
    {
        ...
        # Entity fields added explicitly (robust over forskellige ESPHome versioner)
...
async def to_code(config):
    ...
    # Sikr default så setup_entity ikke kaster KeyError
